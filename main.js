$(document).ready(function(){
    ...
    $("#k").click(function(){
        window.location.href = 'http://127.0.0.1:5500/contactUs.html';
    });
});
$(document).ready(function(){
       ...
       $("#MONA").click(function(){
        window.location.href = 'http://127.0.0.1:5500/(Map)Ribat%20of%20Monastir.html'
                    ...
                    ;$(document).ready(function(){
                        ...
                        $("#fb").click(function(){
                            window.location.href = 'https://www.facebook.com/VisitTUN';
                        })
                        $("#twitter").click(function(){
                            window.location.href = 'https://twitter.com/Visit_Tunisia';
                        })
